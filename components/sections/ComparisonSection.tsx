    ...
    <SectionTemplate background="page" padding="xl">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse min-w-[1000px] bg-slate-800 rounded-lg border border-slate-700 shadow-sm">
            <thead>
              <tr className="border-b border-slate-700 bg-slate-900">
                <th className="text-left py-4 px-4 text-white font-semibold sticky left-0 bg-slate-900 z-10">Feature</th>
            ...
            <tbody>
              {comparisonData.map((row, index) => (
                ...
                >
                  <td className="py-4 px-4 text-white font-semibold sticky left-0 bg-slate-800 z-10">{row.feature}</td>
                  <td className="py-4 px-4 text-yellow-400 font-semibold bg-indigo-600/10">{row.neurondb}</td>
                  <td className="py-4 px-4 text-slate-300">{row.pgvector}</td>
                  <td className="py-4 px-4 text-slate-300">{row.pgvectorscale}</td>
                  <td className="py-4 px-4 text-slate-300">{row.pgai}</td>
                  <td className="py-4 px-4 text-slate-300">{row.postgresml}</td>
                </tr>
              ))}
            </tbody>
          </table>
