  ...
  return (
    ...
    >
      ...
      <g transform="translate(30, 30)">
        <ellipse cx="0" cy="-5" rx="10" ry="3" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-slate-500 dark:text-slate-400" />
        <rect x="-10" y="-5" width="20" height="12" rx="2" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-slate-500 dark:text-slate-400" />
        <ellipse cx="0" cy="7" rx="10" ry="3" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-slate-500 dark:text-slate-400" />
      </g>

      {/* Agent icon (top right) */}
      <g transform="translate(170, 30)">
        <rect x="-8" y="-10" width="16" height="20" rx="3" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-slate-500 dark:text-slate-400" />
        <circle cx="0" cy="-5" r="2" fill="currentColor" className="text-slate-500 dark:text-slate-400" />
        <rect x="-4" y="2" width="8" height="6" rx="1" fill="none" stroke="currentColor" strokeWidth="1" className="text-slate-500 dark:text-slate-400" />
      </g>

      {/* MCP icon (bottom left) */}
      <g transform="translate(30, 170)">
        <rect x="-8" y="-8" width="16" height="16" rx="3" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-slate-500 dark:text-slate-400" />
        <circle cx="0" cy="0" r="4" fill="currentColor" className="text-slate-500 dark:text-slate-400" opacity="0.5" />
        <rect x="-6" y="-6" width="4" height="4" rx="1" fill="currentColor" className="text-slate-500 dark:text-slate-400" />
        <rect x="2" y="2" width="4" height="4" rx="1" fill="currentColor" className="text-slate-500 dark:text-slate-400" />
      </g>
