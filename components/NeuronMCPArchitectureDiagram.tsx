      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-slate-800/60 border-2 border-slate-600 rounded-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <div className="text-white font-semibold mb-1">Validation</div>
              <div className="text-white/70 text-xs">Input checks</div>
            </div>
            <div>
              <div className="text-white font-semibold mb-1">Logging</div>
              <div className="text-white/70 text-xs">Structured logs</div>
            </div>
            <div>
              <div className="text-white font-semibold mb-1">Timeout</div>
              <div className="text-white/70 text-xs">Request limits</div>
            </div>
            <div>
              <div className="text-white font-semibold mb-1">Error Handling</div>
