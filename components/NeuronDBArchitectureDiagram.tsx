  ...
  return (
    <div className="w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-xl p-8 shadow-xl">
      ...
      <div className="max-w-5xl mx-auto">
        {/* PostgreSQL Core */}
        <div className="bg-slate-800/60 border-2 border-slate-600 rounded-xl p-6 mb-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          {/* Vector Engine */}
          <div className="bg-slate-800/60 border-2 border-slate-600 rounded-xl p-5">
        ...
        {/* Advanced Features */}
        <div className="bg-slate-800/60 border-2 border-slate-600 rounded-xl p-6 mb-6">
          <h4 className="text-lg font-bold text-white mb-4 text-center">Advanced Features</h4>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <div className="text-white font-semibold mb-1">Hybrid Search</div>
              <div className="text-white/70 text-xs">Vector + FTS</div>
            </div>
            <div>
              <div className="text-white font-semibold mb-1">Reranking</div>
              <div className="text-white/70 text-xs">Cross-encoder, LLM</div>
            </div>
            <div>
              <div className="text-white font-semibold mb-1">RAG Pipeline</div>
              <div className="text-white/70 text-xs">Complete In-DB</div>
            </div>
            <div>
              <div className="text-white font-semibold mb-1">Background Workers</div>
