...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurondb.ai/docs/neuronmcp/getting-started',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://neurondb.ai/docs/neuronmcp/getting-started',
  },
}
...
export default function NeuronMCPGettingStarted() {
  return (
    <PostgresDocsLayout
