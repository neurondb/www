      ...
      docSections={[
        {
          ...
          items: [
            { title: 'Docker', href: '/docs/getting-started/docker', description: 'Run the full ecosystem (DB + Agent + MCP + Desktop) with Compose profiles.' },
        ...
        },
        {
          ...
          items: [
            { title: 'NeuronAgent', href: '/neuronagent', description: 'AI agent runtime with REST API, WebSocket, long-term memory, and tool execution.' },
            { title: 'NeuronMCP', href: '/neuronmcp', description: 'Model Context Protocol server with 100+ tools (27 PostgreSQL + 70+ NeuronDB) for MCP-compatible clients like Claude Desktop.' },
            { title: 'NeuronDesktop', href: '/neurondesktop', description: 'Unified web interface for managing all NeuronDB ecosystem components with real-time monitoring.' }
          ]
        },
        {
          ...
          items: [
            { title: 'Kubernetes Deployment', href: '/docs/deployment/kubernetes', description: 'Complete cloud-native deployment with Helm charts, HPA, PDB, and persistent storage.' },
            { title: 'Observability Stack', href: '/docs/deployment/observability', description: 'Prometheus metrics, Grafana dashboards, and Jaeger distributed tracing for complete monitoring.' },
            { title: 'Operational Scripts', href: '/docs/deployment/scripts', description: 'Professional automation scripts for Docker, database, setup, health checks, and monitoring.' }
          ]
        },
        {
