...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurondb.ai/docs/neuronagent/getting-started',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://neurondb.ai/docs/neuronagent/getting-started',
  },
}
...
export default function NeuronAgentGettingStarted() {
  return (
    <PostgresDocsLayout
