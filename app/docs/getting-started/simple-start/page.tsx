...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurondb.ai/docs/getting-started/simple-start',
  },
  openGraph: {
...
DROP TABLE test;`}
      ...
      <section id="next-steps">
        ...
        <ul>
          <li>
            ✅ Read <a href="/docs/getting-started/quickstart">Quick Start Guide</a> to understand how to create your first vector table and run semantic searches
          </li>
          <li>
          ...
          <li>
            ✅ If something fails, check <a href="/docs/troubleshooting">troubleshooting guide</a>
          </li>
        </ul>
