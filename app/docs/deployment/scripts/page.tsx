...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurondb.ai/docs/deployment/scripts',
  },
}
...
./scripts/neurondb-database.sh verify`}
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <a href="/docs/deployment/kubernetes">Kubernetes Deployment</a> - Cloud-native deployment guide
          </li>
          <li>
            <a href="/docs/deployment/observability">Observability Stack</a> - Monitoring setup
          </li>
        </ul>
