...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurondb.ai/docs/deployment/kubernetes',
  },
}
  ...
  --set secrets.postgresPassword="dev-password"`}
      ...
      <section id="monitoring">
        ...
        <p>
          ...
          <a href="/docs/deployment/observability">Observability Stack</a> documentation.
        </p>
      </section>
...
# Backup data before uninstalling if needed`}
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <a href="/docs/deployment/observability">Observability Stack</a> - Prometheus, Grafana, and Jaeger setup with metrics and alerting
          </li>
          <li>
            <a href="/docs/deployment/scripts">Operational Scripts</a> - Automation scripts for deployments, database operations, and monitoring
          </li>
        </ul>
      </section>
    </PostgresDocsLayout>
