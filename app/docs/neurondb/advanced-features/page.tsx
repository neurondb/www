...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurondb.ai/docs/neurondb/advanced-features',
  },
  openGraph: {
...
$$ LANGUAGE plpgsql;`}
      ...
      <section>
        ...
        <ul>
          ...
          <li><a href="/docs/neurondb/reranking/llm-reranking">Reranking</a> - Complete reranking documentation</li>
