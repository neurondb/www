...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurondb.ai/docs/neurondb/indexing',
  },
  openGraph: {
...
LIMIT 10;`}
      ...
      <section>
        <h2>Next Steps</h2>
        <ul>
          <li><a href="/docs/neurondb/gpu">GPU acceleration</a> for faster distance computation.</li>
          <li><a href="/docs/neurondb/hybrid">Hybrid search</a> combining vector and full-text search.</li>
