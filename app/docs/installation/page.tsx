    ...
    >
      ...
      <section id="docker-method">
        ...
        <div style={{ backgroundColor: '#1e3a5f', padding: '1rem', borderRadius: '0.5rem', marginTop: '1rem', marginBottom: '1rem' }}>
          <p>
            <strong>💡 Note:</strong> Use <a href="/docs/getting-started/docker" style={{ color: '#fbbf24' }}>Docker</a> to get the complete ecosystem (NeuronDB + NeuronAgent + NeuronMCP + NeuronDesktop) running quickly with automatic configuration.
          </p>
        </div>
      </section>
...
neurondb.gpu_memory_pool_mb = 2048`}
      ...
      <section>
        ...
        <ul>
          <li>
            <a href="/docs/getting-started/docker">Docker Quick Start</a> - Complete ecosystem running in minutes
          </li>
          <li>
