...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    'PostgreSQL AI extension for vector search, machine learning inference, embeddings, and RAG pipelines. GPU-accelerated PostgreSQL extension with 520+ SQL functions, 52 ML algorithms, and complete RAG orchestration. Runs in-process with a SQL-first surface.',
  keywords: [
    // Core AI + PostgreSQL terms
    'postgresql ai',
    'postgres ai',
    ...
    'rag database postgres',
    'embeddings database postgresql',
    'embeddings database postgres',
