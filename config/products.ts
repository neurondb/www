...
export const products: Record<'neurondb' | 'neuronagent' | 'neuronmcp' | 'neurondesktop', ProductMetadata & ProductFeatures & ProductBadges> = {
  neurondb: {
    ...
    keywords: [
      // Core AI + PostgreSQL terms (comprehensive)
      'postgresql ai',
      'postgres ai',
      ...
      'rag framework postgresql',
      'pgvector alternative',
      'postgres ai comparison',
      'postgresql ai tools',
      'neurondb',
      'neurondB',
      'pg ai',
  ...
  neuronagent: {
    ...
    keywords: [
      ...
      'postgres agent framework',
      'autonomous agents',
      'postgresql autonomous agents',
      'postgres autonomous agents',
      // Agentic AI variations
      'agentic AI',
      'agentic AI postgresql',
      'agentic AI postgres',
      'postgresql agentic AI',
