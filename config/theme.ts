...
export const productThemes: Record<ProductId, ProductTheme> = {
  neurondb: {
    ...
    buttonPrimary: 'inline-flex items-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 text-sm font-semibold shadow-lg transition',
    buttonSecondary: 'inline-flex items-center gap-2 rounded-xl border border-indigo-400 hover:border-indigo-300 bg-indigo-600/10 hover:bg-indigo-600/20 text-indigo-300 hover:text-indigo-200 px-6 py-3 text-sm font-semibold transition',
  ...
  neuronagent: {
    ...
    buttonPrimary: 'inline-flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 text-sm font-semibold shadow-lg transition',
    buttonSecondary: 'inline-flex items-center gap-2 rounded-xl border border-blue-400 hover:border-blue-300 bg-blue-600/10 hover:bg-blue-600/20 text-blue-300 hover:text-blue-200 px-6 py-3 text-sm font-semibold transition',
  ...
  neuronmcp: {
    ...
    buttonPrimary: 'inline-flex items-center gap-2 rounded-xl bg-green-600 hover:bg-green-700 text-white px-6 py-3 text-sm font-semibold shadow-lg transition',
    buttonSecondary: 'inline-flex items-center gap-2 rounded-xl border border-green-400 hover:border-green-300 bg-green-600/10 hover:bg-green-600/20 text-green-300 hover:text-green-200 px-6 py-3 text-sm font-semibold transition',
  ...
  neurondesktop: {
    ...
    buttonPrimary: 'inline-flex items-center gap-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 text-sm font-semibold shadow-lg transition',
    buttonSecondary: 'inline-flex items-center gap-2 rounded-xl border border-purple-400 hover:border-purple-300 bg-purple-600/10 hover:bg-purple-600/20 text-purple-300 hover:text-purple-200 px-6 py-3 text-sm font-semibold transition',
